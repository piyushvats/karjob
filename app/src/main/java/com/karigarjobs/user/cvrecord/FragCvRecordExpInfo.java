 ...
 * Use the {@link FragCvRecordExpInfo#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragCvRecordExpInfo extends Fragment {
     ...
     * @return A new instance of fragment FragCvRecordExpInfo.
     */
    // TODO: Rename and change types and number of parameters
    public static FragCvRecordExpInfo newInstance(String param1, String param2) {
        FragCvRecordExpInfo fragment = new FragCvRecordExpInfo();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_frag_cv_record_exp_info, container, false);
        Button btn1 = (Button)view.findViewById(R.id.q_button1);
        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startplayrecordactvity(R.raw.q7,201,getResources().getString(R.string.title_totalwrkexp));
            }
        });
        if(checkfileavial(String.valueOf(201) + mediasuffix)) {
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startplayrecordactvity(R.raw.q8,202,getResources().getString(R.string.title_prasenttcompname));
            }
        });
        if(checkfileavial(String.valueOf(202) + mediasuffix)) {
        ...
        btn3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startplayrecordactvity(R.raw.q9,203,getResources().getString(R.string.title_yourworkincomp));
            }
        });
        if(checkfileavial(String.valueOf(203) + mediasuffix)) {
        ...
        btn4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startplayrecordactvity(R.raw.q10,204,getResources().getString(R.string.title_whenyoustartwrkcomp));
            }
        });
        if(checkfileavial(String.valueOf(204) + mediasuffix)) {
        ...
        btn5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startplayrecordactvity(R.raw.q11,205,getResources().getString(R.string.title_whereisyourcomp));
            }
        });
        if(checkfileavial(String.valueOf(205) + mediasuffix)) {
        ...
        nextfrag.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Fragment newFragment = new FragCvRecordEduInfo();
