...
public class SettingsUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgtn = (ImageView)findViewById(R.id.imgpropic_sett);
...
/*                if( strmo.length() != 10 )
        ...
        String propic = fileSelectPath + "profpic.jpg";
        ...
        if(f.exists()) {
            try {
                ...
                Toast.makeText(getApplicationContext(),getResources().getText(R.string.err_check_file_perm_settings),Toast.LENGTH_LONG).show();
                e.printStackTrace();
            }
        }
    ...
    public String opendir() {
        String outdirpath = fileSelectPath + "profpic.jpg";
    ...
    void setproffilename(String flpath) throws IOException {
        ...
        //ImageView imgtn = (ImageView)findViewById(R.id.imgpropic_sett);
